...
function MainMenuLoadPage() {
    ...
    $script:SystemInformation = New-LinkyText "System Information" (50, 130)
    ...
    $script:SystemDiagnostic = New-LinkyText "System Diagnostic" (50, 160)
    ...
    $script:UpdateSystemBIOS = New-LinkyText "Update System BIOS"  (50, 190) 
#    $script:UpdateSystemBIOS.Enabled = $false
    ...
    $script:ChangeDateTime = New-LinkyText "Change Date and Time" (50, 230)
